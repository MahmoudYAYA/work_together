 ...
 */
final class Version20251218123821 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande ADD clients_id INT DEFAULT NULL, ADD clientss_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE commande ADD CONSTRAINT FK_6EEAA67D1463CD2B FOREIGN KEY (clientss_id) REFERENCES client (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande DROP FOREIGN KEY FK_6EEAA67D1463CD2B');
        $this->addSql('DROP INDEX IDX_6EEAA67DAB014612 ON commande');
        $this->addSql('DROP INDEX IDX_6EEAA67D1463CD2B ON commande');
        $this->addSql('ALTER TABLE commande DROP clients_id, DROP clientss_id');
